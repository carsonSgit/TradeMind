    ...
    return (
        <div className="container">
          <div className="row">
            ...
            <AboutPageText textContent={kevinSummary} nameContent="Kevin Baggott" side="right" link={kevinPortfolio} />
          </div>
          <div className="row">
            <AboutPageImage imageUrl="../about/cristianoImage.jpg" side="right" />
            <AboutPageText textContent={cristianoSummary} nameContent="Cristiano Fazi" side="left" link={cristianoPortfolio} />
          </div>
          <div className="row">
            <AboutPageImage imageUrl="../about/carsonspriggs.jpg" side="right" />
            <AboutPageText textContent={carsonSummary} nameContent="Carson Spriggs" side="right" link={carsonPortfolio}/>
          </div>
          <div className="row">
            <AboutPageImage imageUrl="logo512.png" side="right" />
            <AboutPageText textContent={felixSummary} nameContent="Felix St-Laurent" side="left" link={felixPortfolio}/>
          </div>
          <div className="row">
            <AboutPageImage imageUrl="../about/cindyIcon.jpg" side="right" />
            <AboutPageText textContent={cindySummary} nameContent="Cindy Coulibaly" side="right" link={cindyPortfolio}/>
          </div>
        </div>
      );
}